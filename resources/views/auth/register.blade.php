...
<div class="flex justify-center items-center min-h-screen bg-green-50">
    <div class="w-full max-w-md p-8 bg-white shadow-lg rounded-lg border border-green-200">
        <h2 class="text-2xl font-semibold text-center text-green-600 mb-6">Register</h2>
        ...
        <form action="{{ route('landing') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input id="fullname" class="form-input mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500" type="text" name="fullname" value="{{ old('fullname') }}" required />
            </div>
            ...
            <div class="mb-4">
                ...
                <input id="email" class="form-input mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500" type="email" name="email" value="{{ old('email') }}" required />
            </div>

            <div class="mb-4">
                <label for="phone" class="block text-sm font-medium text-gray-700">Nomor HP</label>
                <input id="phone" class="form-input mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500" type="text" name="phone" value="{{ old('phone') }}" />
            </div>
            ...
            <div class="mb-6">
                ...
                <input id="password_confirmation" class="form-input mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500" type="password" name="password_confirmation" required />
            </div>

            <div class="flex justify-between items-center">
                <button class="w-full py-2 px-4 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 mx-1" type="submit">Register</button>
