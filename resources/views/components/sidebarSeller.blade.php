    ...
    <nav class="mt-10">
        <ul class="space-y-4 ml-4 text-white text-lg">
            <li class="flex items-center">
                ...
                <a href="{{ route('seller.dashboard') }}" class="block py-2 px-3 rounded hover:bg-green-500 transition duration-300 ease-in-out {{ request()->routeIs('seller.dashboard') ? 'bg-green-600' : '' }}">Beranda</a>
            </li>
            <li class="flex items-center">
                <span class="iconify text-3xl text-greenPrimary" data-icon="solar:box-bold-duotone" data-inline="false"></span>
                <a href="{{ route('seller.view-product') }}" class="block py-2 px-3 rounded hover:bg-green-500 transition duration-300 ease-in-out {{ request()->routeIs('user.cart') ? 'bg-green-600' : '' }}">Kelola Produk</a>
            </li>
            <li class="flex items-center">
                <span class="iconify text-3xl text-greenPrimary" data-icon="icon-park-twotone:transaction-order" data-inline="false"></span>
                <a href="{{ route('seller.view-order') }}" class="block py-2 px-3 rounded hover:bg-green-500 transition duration-300 ease-in-out {{ request()->routeIs('seller.view-order') ? 'bg-green-600' : '' }}">Pesanan</a>
            </li>
            <li class="flex items-center">
                <span class="iconify text-3xl text-greenPrimary" data-icon="ic:twotone-calculate" data-inline="false"></span>
                <a href="{{ route('seller.kalkulasipestisida') }}" class="block py-2 px-3 rounded hover:bg-green-500 transition duration-300 ease-in-out {{ request()->routeIs('seller.kalkulasipestisida') ? 'bg-green-600' : '' }}">Kalkulasi Pestisida</a>
            </li>
            <li class="flex items-center">
                <span class="iconify text-3xl text-greenPrimary" data-icon="ant-design:security-scan-twotone" data-inline="false"></span>
                <a href="{{ route('seller.detect.form') }}" class="block py-2 px-3 rounded hover:bg-green-500 transition duration-300 ease-in-out {{ request()->routeIs('seller.detect.form') ? 'bg-green-600' : '' }}">Deteksi Penyakit</a>
            </li>
            <li class="flex items-center">
