            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="divide-y divide-gray-200">
                    @forelse ($carts as $cart)
                        <div class="p-6 hover:bg-gray-50 transition duration-150" id="cart-item-{{ $cart->id }}" data-product-id="{{ $cart->id }}">
                                    ...
                                    <div class="mt-4 flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ $cart->quantity }}" 
                                                   min="1"
                                                   class="w-16 h-10 text-center border rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                                                   data-product-id="{{ $cart->id }}">
                                        ...
                                        <form action="{{ route('cart.remove', $cart->product->id) }}" 
                                            method="POST" 
                                            class="inline">
                                          @csrf
                                          @method('DELETE')
...
<div id="notification" class="fixed top-4 right-4 transform translate-x-full transition-transform duration-300 ease-in-out"></div>
